...
def main() -> None:
    ...
    parser.add_argument("--algo", default="./jonghyeok/round3/HJ_hydro_rolling_mean_for_sweep.py")
    ...
    parser.add_argument("--lengths", default="10,20,30,40,50,70,100,150,200,300,500,750,1000")
