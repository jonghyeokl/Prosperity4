...
def main() -> None:
    ...
    parser.add_argument("--algo", default="./jonghyeok/round3/HJ_hydro_ema_zscore_for_sweep.py")
    ...
    parser.add_argument("--z-thresholds", default="0,0.25,0.5,0.75,1,1.25,1.5,2,2.5,3")
