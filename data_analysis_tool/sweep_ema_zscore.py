...
def main() -> None:
    ...
    parser.add_argument("--algo", default="./data_analysis_tool/ema_zscore_for_sweep.py")
    ...
    parser.add_argument("--ema-windows", default="10,20,50,100,150,200,300,500,750,1000") #5,10,20,30,40,50,70,100,150,200,300,500,750,1000
    parser.add_argument("--z-thresholds", default="0,0.25,0.5,0.75,1,1.25,1.5,2,2.5") #0,0.25,0.5,0.75,1,1.25,1.5,2,2.5,3
