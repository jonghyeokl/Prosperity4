...
class Trader:
    ...
    def run(self, state: TradingState, day_num) -> (Dict[Symbol, List[Order]], int, str):
        ...
        current_round = state.timestamp / 1000000 + day_num
